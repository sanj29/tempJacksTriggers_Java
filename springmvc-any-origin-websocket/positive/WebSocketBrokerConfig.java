...
public class WebSocketBrokerConfig extends AbstractWebSocketMessageBrokerConfigurer {
    ...
    public void registerStompEndpoints(StompEndpointRegistry registry) {
        ((WebSocketHandlerRegistration) registry.addEndpoint("/messages")).setAllowedOrigins("http://foo.com").withSockJS();
    }

    //calling setAllowedOrigins on StompEndpointRegistry instance
    protected void configureStompEndpoints(StompEndpointRegistry registry) {
        registry.addEndpoint("/foo").setAllowedOrigins("http://lawl.com").withSockJS();
    }
